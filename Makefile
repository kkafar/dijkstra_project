all: main.o log.o graph.o Timer.o
	g++ --std=c++17 ./src/main.o ./lib/log/log.o ./lib/graph/graph.o ./lib/Timer/Timer.o -lsfml-graphics -lsfml-window -lsfml-system -o ./bin/main
